...
const PlaceDetail = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost/melb_tram_api/public/getReviews.php?place_id=${id}`)
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="mb-6">
        <button
          onClick={() => navigate(`/place/${id}/post_review`)}
          ...
          reviews.map((review) => (
            ...
            >
              <div className="flex justify-between">
                ...
                {review.image_url && (
                <img src={`http://localhost/melb_tram_api${review.image_url}`}
                    alt="후기 이미지"
